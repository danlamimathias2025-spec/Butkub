...
const translations: Translations = {
  ...
  upload_doc: { EN: 'Upload Government Issued Card', TH: 'อัปโหลดบัตรที่ออกโดยรัฐบาล' },
  doc_instruction: { EN: 'Upload any Government Issued Card.', TH: 'อัปโหลดบัตรประชาชน หรือบัตรที่ออกโดยรัฐบาล' },
  doc_sub_instruction: { EN: 'Ensure your ID card, driver\'s license, passport, or official ID is clearly visible with all edges.', TH: 'ตรวจสอบให้แน่ใจว่าบัตรประชาชน ใบขับขี่ พาสปอร์ต หรือบัตรราชการเห็นขอบชัดเจน' },
  upload_button: { EN: 'Take Photo / Upload Document', TH: 'ถ่ายภาพ / อัปโหลดเอกสาร' },
  linked_bank_label: { EN: 'Verified Phone Number', TH: 'เบอร์โทรศัพท์ที่ใช้ยืนยันตัวตน' },
  phone_number_placeholder: { EN: 'Enter your phone number (e.g., 0812345678)', TH: 'กรอกเบอร์โทรศัพท์ของคุณ (เช่น 0812345678)' },
